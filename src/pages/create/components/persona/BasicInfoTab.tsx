      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          <Label htmlFor="positionTitle" className="font-medium" style={{ color: colors.text }}>
            {t('createPersonaPage.form.positionTitle.label')} <span style={{ color: colors.error }}>*</span>
          </Label>
          <Input 
            id="positionTitle" 
            name="positionTitle" 
          ...
          />
          {errors.positionTitle && <p className="text-sm" style={{ color: colors.error }}>{errors.positionTitle}</p>}
        </div>

        {/* Department and Industry */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label htmlFor="departmentOrArea" className="font-medium" style={{ color: colors.text }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-2">
            <Label htmlFor="experienceLevel" className="font-medium" style={{ color: colors.text }}>
              {t('createPersonaPage.form.experienceLevel.label')} <span style={{ color: colors.error }}>*</span>
            </Label>
            ...
            {errors.experienceLevel && <p className="text-sm" style={{ color: colors.error }}>{errors.experienceLevel}</p>}
          </div>
          <div className="space-y-2">
            <Label htmlFor="minExperienceYears" className="font-medium" style={{ color: colors.text }}>
              {t('createPersonaPage.form.minExperienceYears.label')} <span style={{ color: colors.error }}>*</span>
            </Label>
            <Input 
            ...
            />
            {errors.minExperienceYears && <p className="text-sm" style={{ color: colors.error }}>{errors.minExperienceYears}</p>}
          </div>
          <div className="space-y-2">
            <Label htmlFor="maxExperienceYears" className="font-medium" style={{ color: colors.text }}>
        ...
        <div className="space-y-2">
          <Label htmlFor="minEducationLevel" className="font-medium" style={{ color: colors.text }}>
            {t('createPersonaPage.form.minEducationLevel.label')} <span style={{ color: colors.error }}>*</span>
          </Label>
          ...
          {errors.minEducationLevel && <p className="text-sm" style={{ color: colors.error }}>{errors.minEducationLevel}</p>}
        </div>
      </CardContent>
    </Card>
  );
