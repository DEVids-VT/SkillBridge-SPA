...
export function Layout() {
  ...
  return (
    <div
      className="flex h-screen overflow-hidden font-rubik"
      style={{ backgroundColor: colors.bgSlate900 }}
    >
      {/* Sidebar */}
      <Sidebar isOpen={sidebarOpen} onToggle={toggleSidebar} onCollapse={handleSidebarCollapse} />
