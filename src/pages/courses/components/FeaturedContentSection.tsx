              ...
              <Card key={course.id} className="overflow-hidden">
                ...
                <CardContent>
                  ...
                  <div className="flex items-center text-sm text-gray-500">
                    ...
                    <span>
                      {t('coursesPage.requiredProject')}:{' '}
                      <span className="font-medium">{course.requiredProject}</span>
                    </span>
                  </div>
                </CardContent>
              ...
              <Card key={company.id}>
                ...
                <CardContent>
                  <div className="flex justify-between text-sm mb-4">
                    <div>
                      <span className="font-semibold text-primary">{company.courses}</span>{' '}
                      {t('coursesPage.coursesAvailable')}
                    </div>
                    <div>
                      <span className="font-semibold text-primary">{company.projects}</span>{' '}
                      {t('coursesPage.projectsAvailable')}
                    </div>
                  </div>
                </CardContent>
                <CardFooter>
                  <Button variant="outline" className="w-full" asChild>
                    <a href="/companies">{t('coursesPage.viewCompany')}</a>
                  </Button>
                </CardFooter>
              </Card>
            ))}
