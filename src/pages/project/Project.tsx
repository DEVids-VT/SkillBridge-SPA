...
import ProjectCompanyInfo from './components/project-companyinfo/ProjectCompanyInfo';
import ProjectDetails from './components/project-details/ProjectDetails';
import ProjectClaimSection from './components/project-claim/ProjectClaim';
import ProjectHowItWorks from './components/project-howitworks/ProjectHowItWorks';
      ...
      <div className="flex h-full min-h-0" style={{ backgroundColor: colors.bgSlate900 }}>
        <div className="flex-1 overflow-y-auto rounded-xl" style={{ backgroundColor: colors.dark }}>
          <main className="p-4 lg:p-6">
            <div className={cn('py-4 md:py-8', 'flex justify-center items-center min-h-[60vh]')}>
              <div className="text-center">
                <Loader2 className="h-12 w-12 animate-spin text-blue-600 mx-auto mb-4" />
                <p className="text-lg font-medium text-gray-300">
                  {t('projectPage.loading.message')}
                </p>
              </div>
            </div>
          </main>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-4">
              ...
              >
                ...
                {t('projectPage.actions.backToProjects') || 'Back to projects'}
              </Link>
            </div>
