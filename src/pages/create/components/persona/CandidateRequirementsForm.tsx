...
export function CandidateRequirementsForm(props: CandidateRequirementsFormProps) {
  ...
  const getTabTitle = (tab: TabValue) => {
    switch (tab) {
      case 'basic':
        return t('createPersonaPage.form.tabs.basic');
      case 'skills':
        return t('createPersonaPage.form.tabs.skills');
      case 'details':
        return t('createPersonaPage.form.tabs.details');
      default:
        return '';
    }
  };
  ...
  const getTabDescription = (tab: TabValue) => {
    switch (tab) {
      case 'basic':
        return t('createPersonaPage.form.tabs.basicDescription');
      case 'skills':
        return t('createPersonaPage.form.tabs.skillsDescription');
      case 'details':
        return t('createPersonaPage.form.tabs.detailsDescription');
      default:
        return '';
    }
  };
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
              ...
              <div key={tab} className="flex items-center">
                <div
                  className={cn(
                    ...
                    index <= currentTabIndex ? 'text-white' : 'text-gray-400'
                  )}
                  style={{
          ...
          <div className="text-sm" style={{ color: colors.textMuted }}>
            {t('createPersonaPage.form.stepCounter', {
