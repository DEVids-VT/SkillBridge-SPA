...
export function CourseCard({
  ...
  return (
    <div
      className={cn(cards.base, 'flex flex-col h-full cursor-pointer transition-colors text-white')}
    ...
    >
      ...
      <div className="flex-1 p-5">
        ...
        <p className="text-sm mb-2" style={{ color: colors.yellow }}>
          By {instructor}
        </p>
        ...
        >
          ...
          <span className="flex items-center gap-1">
            <Star className="h-4 w-4" style={{ color: colors.yellow, fill: colors.yellow }} />
            {rating}
          </span>
        </div>
      ...
      <div className="p-5 pt-0 mt-auto">
        <div className="flex items-center justify-between mb-4">
          <div>
            <span className="text-2xl font-bold" style={{ color: colors.yellow }}>
              ${price}
            </span>
            {originalPrice > price && (
              <span
          ...
          <Badge variant="secondary" style={{ backgroundColor: colors.blue, color: colors.yellow }}>
            {level}
          </Badge>
        </div>
