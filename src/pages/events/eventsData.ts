...
export const eventsData: EventProps[] = [
  {
    ...
    description:
      'Join us for a 48-hour coding challenge to build innovative solutions for sustainability challenges.',
  ...
  },
  {
    ...
    description:
      'A virtual conference focused on design systems, component libraries, and scaling design in organizations.',
  ...
  },
  {
    ...
    description:
      'Hands-on workshop about practical applications of AI and ML in business. Bring your laptop!',
  ...
  },
  {
    ...
    description:
      'Monthly meetup for frontend developers to network, share knowledge, and discuss latest trends.',
  ...
  },
  {
    ...
    description:
      'Technical lecture on designing scalable and resilient cloud architectures for enterprise applications.',
  ...
  },
  {
    ...
    description:
      'Learn practical product management skills from industry leaders. Ideal for aspiring and junior PMs.',
